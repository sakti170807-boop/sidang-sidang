...
@section('title', 'Tambah Ruang Sidang')
...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="bg-white shadow-md rounded-xl p-6">
        <form action="{{ route('admin.ruang-sidang.store') }}" method="POST">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="fasilitas" rows="3" 
                              class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none" 
                              placeholder="Contoh: Proyektor, AC, Papan Tulis, Wifi">{{ old('fasilitas') }}</textarea>
